package com.intunisia.views.place;

import com.intunisia.data.entity.SampleFoodProduct;
import com.intunisia.data.service.SampleFoodProductService;
import com.intunisia.views.MainLayout;
...
@PageTitle("Place")
@Route(value = "place/:sampleFoodProductID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class PlaceView extends Div implements BeforeEnterObserver {

    private final String SAMPLEFOODPRODUCT_ID = "sampleFoodProductID";
    private final String SAMPLEFOODPRODUCT_EDIT_ROUTE_TEMPLATE = "place/%d/edit";
    ...
    public PlaceView(@Autowired SampleFoodProductService sampleFoodProductService) {
        this.sampleFoodProductService = sampleFoodProductService;
        addClassNames("place-view", "flex", "flex-col", "h-full");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleFoodProductId.isPresent()) {
            ...
            if (sampleFoodProductFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(PlaceView.class);
            }
        }
    }
